...
public class hgScoresHoF : MonoBehaviour {
    ...
    DisplayHighscoresHoF highscoreDisplay;
    public Highscore[] highscoresList;
    static hgScoresHoF instance;
    public string nname;
    ...
    void Awake() {
        ...
        //Debug.Log(nscoreInt);*/
        highscoreDisplay = gameObject.GetComponent<DisplayHighscoresHoF> ();
        instance = this;
    }
